...
public class RoleController {
	...
	public Object loadDataAsync(Integer roleid) {		
		...
		List<Integer> assignedPermissionIds = permissionService.queryPermisionIdByRoleid(roleid); //这个角色之前所分配的许可id集合
		...
		for (Permission permission : allPermissionList) {
			...
			if(assignedPermissionIds.contains(permission.getId())) { //判断许可是否被分配过
